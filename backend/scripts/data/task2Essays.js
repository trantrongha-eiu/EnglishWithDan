...
const ESSAY = {
  ...
  'High Rates of University Dropout': {
    ...
    body1: 'The leading cause is financial hardship. Tuition and living costs have risen faster than family incomes in many countries, so a large share of students now take on paid work alongside a full-time course. Once those hours climb past fifteen or twenty a week, the pattern is predictable: lectures are missed, reading is skipped and assignments are rushed, and because each module builds on the last, the student falls a little further behind every term until catching up feels impossible. This is common at large public universities where many undergraduates commute and hold near-full-time jobs. A second cause is poor course choice. Teenagers often select a subject with little careers guidance, and those who realise months in that it does not suit them tend to lose the motivation needed to push through the difficult years.',
    body2: 'The effects are damaging at every level. For the individual, years of time and money produce no qualification, often leaving the student with debt but none of the earning power a degree brings, a setback that can hold back a career for a decade. Universities lose the fees and the teaching invested in a place that is never completed, and are pushed into running ever-larger first-year cohorts to absorb the expected losses. Society then pays twice: it has partly funded an education that yields no graduate, and it is left with an unfilled skills gap in fields such as engineering and healthcare. Employers compete for a smaller pool of qualified staff, which drives up wages, delays projects and, in the long run, slows economic growth.',
  },
  'Decline in STEM Course Enrolments': {
    ...
    body1: 'One major cause lies in how science is taught before university. In many schools it is presented as a body of abstract formulae to be memorised for exams, often by non-specialist teachers and without the laboratory equipment that would make it feel real, so students come away convinced the subject is both dull and punishingly hard. A second cause is the perceived payoff. Teenagers rarely meet working engineers or researchers and cannot picture the careers a science degree leads to, whereas business and law seem to offer clearer routes to a comfortable salary. Faced with a choice that looks like years of difficulty without an obvious reward, many capable students simply opt for something else.',
    body2: 'The effects build slowly but seriously. As home-grown graduates in engineering, computing and the physical sciences become scarcer, technology firms are forced either to recruit specialists from abroad or to move research units to where the talent already is, and both options raise costs and hollow out local expertise. Germany and South Korea have repeatedly warned that engineer shortages are holding back their manufacturing sectors. Over a longer horizon, a thin STEM pipeline slows the innovation on which productivity and new industries depend, so a country that cannot train enough scientists steadily loses ground to competitors that can.',
  },
  'Online Learning and Student Motivation': {
    ...
    body1: 'The first cause is the loss of direct supervision and social presence. In a classroom a teacher notices when a student drifts off, offers a quiet word of encouragement, and clears up a point of confusion on the spot; online, these small corrections disappear, and weaker or anxious learners in particular are left with nothing external to keep them on task. The second cause is the home itself. A bedroom or a kitchen table sits within reach of the television, family members, a bed and a phone, none of which a classroom allows, so every study session turns into a contest against easier options that the student usually loses.',
    body2: 'These conditions have a clear effect on learning. Without imposed structure, students hand in work late, revise less thoroughly and score below their real ability; a large share eventually stop logging in altogether, which is why fully online courses tend to have far higher drop rates than the same course taught on campus. The harm is not only academic. Learners who spend months studying alone report feeling cut off from their teachers and classmates, and that isolation slowly erodes the confidence and sense of belonging that keep people engaged with education in the first place.',
  },
  'Dropout Rates in Higher Education': {
    ...
    body1: 'One major cause is the cost of studying. As tuition and rent have outpaced student support in many systems, undergraduates increasingly rely on long shifts of paid work, and the resulting fatigue and missed classes make it hard to keep pace with assessment. A second, less obvious cause is inadequate preparation for how university actually works. School tends to spoon-feed content and set frequent deadlines, whereas a degree demands independent reading, self-imposed structure and long unsupervised projects. First-year students who get little guidance through this transition — a well-documented weak point at many European universities — can feel lost within weeks, and once they are behind and unsupported, quietly withdrawing feels easier than asking for help.',
    body2: 'The consequences fall on both the student and the wider public. Individuals lose one to three years of potential earnings and may be left repaying loans for a course that gives them no credential, a financial setback that shapes their choices well into their thirties. For the state, every dropout represents tax revenue spent on a place that produced no graduate and no return. As the share of non-completers grows, the gap in income and opportunity between those who finish a degree and those who merely start one widens, so a trend that looks like an individual misfortune gradually entrenches inequality across a whole generation.',
  },
  'Rise in Modern Mental Stress & Anxiety': {
    ...
    body1: 'The primary cause is the intensity of modern working life. Job insecurity, always-on email and constant performance comparison mean that many employees never fully switch off, and a nervous system kept in a low-level state of alert for months at a time eventually tips into anxiety. Social media compounds this. Scrolling through carefully edited versions of other people’s lives invites relentless comparison, while an endless feed of alarming news keeps users agitated about problems they can do nothing about. Someone who checks a phone last thing at night and first thing in the morning is, in effect, giving their mind no time to rest, and over years this quietly wears down their ability to cope.',
    body2: 'The most effective response is to make help easy to reach before a crisis develops. Workplaces and schools should offer free, confidential counselling with short waiting times, as parts of Scandinavia already do, so that a person struggling in week one is seen in week two rather than in month six. Prevention matters just as much. Teaching stress management, sleep habits and simple techniques for challenging anxious thoughts in secondary school gives people tools they can use for life, and public campaigns that treat anxiety as a common, treatable condition make individuals far more willing to seek support early, when it is cheapest to provide and most likely to work.',
  },
  ...
  'Individual vs. Government Responsibility': {
    ...
    intro: 'Some people argue that ordinary individuals can do nothing meaningful to protect the environment, while others believe personal choices do matter. This essay will consider both views before giving my own opinion.',
    body1: 'Those who doubt individual action have a point. The majority of global greenhouse-gas emissions come from a small number of fossil-fuel corporations and from energy, transport and agriculture systems that a single person cannot change. Without government regulation and large-scale investment, one household switching off lights or recycling makes a negligible difference, and constant guilt about "personal responsibility" can even distract from the real problem.',
    body2: 'However, individual choices still count in two ways. First, they add up: when millions of European households installed rooftop solar and cut their meat consumption, the surge in demand pushed the whole energy market towards cleaner options. Second, people who change their own behaviour are far more likely to vote for green policies and pressure companies to act. Individual and government responsibility are therefore not alternatives but reinforce each other, which is why I believe personal action does matter.',
  },
  'Car-Free Days vs. Alternative Solutions': {
    ...
    intro: 'Some people believe that international car-free days are an effective tool against air pollution, while others think there are better approaches. This essay will discuss both positions before explaining why I favour long-term measures.',
    body1: 'Supporters of car-free days point to their value as awareness campaigns. For one day, residents experience quieter, cleaner streets and see that a city can function without private cars, which can build the political support needed for lasting change. Bogotá\'s annual car-free day and weekly "Ciclovía" have measurably shifted local attitudes towards cycling, and such events are cheap and simple to organise.',
    body2: 'However, a single day has only a symbolic, one-off effect on pollution. The most durable improvements come from structural change: London\'s congestion charge and ultra-low-emission zone have cut traffic and dirty air far more than any event could, and investment in reliable public transport, protected cycle lanes and tighter vehicle-emission standards changes how people travel every day. For this reason I believe these alternatives are the more effective solution.',
  },
  'Lack of Fluency in Foreign Languages': {
    ...
    intro: 'Although students study foreign languages for years at school, many still cannot hold a fluent conversation after graduating. This essay will examine the causes of this situation and the solutions that could improve language education.',
    body1: 'The main causes lie in how languages are taught. Large classes and an exam system that rewards written grammar mean lessons focus on rules and translation rather than speaking and listening, so students rarely practise real communication. Opportunities to use the language outside class are also scarce, and a fear of making mistakes stops many learners from speaking at all. By contrast, in lower-performing countries lessons still spend most of their time copying grammar and sitting written tests.',
    body2: 'Several solutions could help. Adopting a communicative approach, with smaller classes and far more speaking and listening practice, would build confidence and fluency. Exposure to authentic input matters too: Nordic countries such as the Netherlands and Sweden reach a very high level of English partly because they subtitle rather than dub foreign films and television. Language-exchange schemes, summer camps and speaking-based assessment would reinforce these gains.',
  },
  'Lack of Practical Life Skills': {
    ...
    intro: 'Many young people leave school or university without everyday skills such as managing money or preparing meals. This essay will discuss the effects of this on individuals and society and the solutions that could be introduced.',
    body1: 'The effects begin with the individual. Someone who cannot budget is more likely to fall into debt, and someone who cannot cook tends to rely on expensive, unhealthy convenience food. Surveys in the UK and the US find that most school-leavers cannot draw up a simple monthly budget or explain compound interest. This pushes up rates of personal debt and diet-related illness, so the costs eventually fall on society through welfare and healthcare spending.',
    body2: 'The clearest solution is to teach these skills at school. Making personal finance, basic cooking and simple home repairs a compulsory part of the curriculum, taught through practical projects such as planning a class budget or a week of meals, would give every student hands-on experience. Some US states have already made financial education compulsory, and studies show that students then take on less risky debt. Parents can support this by giving children chores and small financial responsibilities early.',
  },
};

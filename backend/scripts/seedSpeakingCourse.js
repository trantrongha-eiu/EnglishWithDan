// scripts/seedSpeakingCourse.js
// Seed the structured IELTS Speaking course (reuses the WT1 system, courseCode IELTS-SPEAKING).
//
//   node scripts/seedSpeakingCourse.js         # upsert into the DB
//   node scripts/seedSpeakingCourse.js --dry   # validate + tally, write nothing
//
...
const DATA_DIR = path.join(__dirname, 'data', 'speakingCourse');
...
async function main() {
  ...
  console.log(`[SpeakingSeed] ${dry ? 'DRY RUN — không ghi gì' : 'seeding'}\n`);

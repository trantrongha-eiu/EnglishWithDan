...
//
//   node scripts/seedNounPhraseCourse.js         # upsert into the DB
//   node scripts/seedNounPhraseCourse.js --dry   # validate + tally, write nothing
//
...
const DATA_DIR = path.join(__dirname, 'data', 'nounPhrase');
...
async function main() {
  ...
  console.log(`[NounPhraseSeed] ${dry ? 'DRY RUN — không ghi gì' : 'seeding'}\n`);

...
export default function ListeningSectionEdit() {
  ...
  // content, and vice versa. Rendering/generate/save logic lives in the
  // shared <GapFillPanel> (also used from ListeningSections.jsx's list
  // view) — this page just owns the value + passes it down.
  ...
  return (
    <div style={{ maxWidth: 960, margin: '0 auto', padding: '24px 20px' }}>
      ...
      {savedId && (
        <div className="card" style={{ padding: 20, marginBottom: 20 }}>
          <GapFillPanel sectionId={savedId} transcript={meta.transcript} value={gapFill} onChange={setGapFill} />
        </div>
      )}

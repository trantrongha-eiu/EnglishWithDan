...
function _renderUpgradeBankInfo() {
  ...
  if (s.paymentNote) rows.push(`<div class="up-bank-row"><span class="up-bank-label">📋 Nội dung CK</span><span class="up-bank-val" id="up-transfer-content">${escHtml(s.paymentNote)}</span></div>`);

/* ═══════════════════════════════════════════════════════════════════════
   frontend/js/reading-v2.js  –  EnglishWithDan Reading Module v2
...
let _rdPage = 1;
const RD_PAGE_SIZE = 8; // 4-column grid → exactly 2 full rows per page (matches Listening)
...
function renderSingleQuestion(q, isReview, reviewMap) {
  ...
  if (type === 'true-false-ng') {
    ...
    // fallback: nếu không được cluster từ renderPlainGroup, render riêng lẻ như 1-question cluster
    return renderMultiAnswerCluster([q], isReview, reviewMap);

import{i as e,n as t,t as n}from"./jsx-runtime-bzQ4Vb5N.js";import{F as r,N as i,O as a,k as o,w as s}from"./index-sRwJbY9D.js";import{t as c}from"./ImportStatusBox-jqPZ3AQp.js";import{t as l}from"./LessonPreview-msY0fttI.js";var u=e(t(),1),d=n(),f=`Bạn là trợ lý biên soạn nội dung từ vựng tiếng Anh cho học sinh luyện thi IELTS.
...
Số lượng từ mong muốn: [DÁN SỐ LƯỢNG VÀO ĐÂY]`,p=`vocabLessonImportPrefill`;function m(){let e=o(),t=a(),n=i(),[m]=r(),h=m.get(`lessonId`),[g,_]=(0,u.useState)(()=>{if(h)return``;let e=sessionStorage.getItem(p);return e&&sessionStorage.removeItem(p),e||``}),[v,y]=(0,u.useState)(``),[b,x]=(0,u.useState)(!!h),[S,C]=(0,u.useState)(!1),[w,T]=(0,u.useState)(!1),[E,D]=(0,u.useState)(null);(0,u.useEffect)(()=>{h&&s(`/vocabulary-lessons/admin/${h}`).then(e=>{_(e.lesson.rawImport||``),y(e.lesson.title)}).catch(t=>e(t.message,`error`)).finally(()=>x(!1))},[h]);async function O(){if(!g.trim()){e(`Chưa có nội dung để kiểm tra`,`warn`);return}C(!0);try{let t=await s(`/vocabulary-lessons/admin/parse`,{method:`POST`,body:JSON.stringify({text:g})});D(t),t.valid?e(`✓ Hợp lệ — ${t.words.length} từ`+(t.warnings?.length?` (${t.warnings.length} cảnh báo)`:``)):e(`✗ ${t.errors.length} lỗi`,`error`)}catch(t){e(t.message,`error`)}finally{C(!1)}}async function k(){if(!g.trim()){e(`Chưa có nội dung để import`,`warn`);return}T(!0);try{let t=await s(h?`/vocabulary-lessons/admin/${h}/reimport`:`/vocabulary-lessons/admin/import`,{method:h?`PUT`:`POST`,body:JSON.stringify({text:g})});e(t.message),n(`/vocabulary-lessons`)}catch(t){e(t.message,`error`),t.body?.errors&&D({valid:!1,errors:t.body.errors,lesson:null,words:[]})}finally{T(!1)}}function A(){g.trim()&&t(`Xoá toàn bộ nội dung đang nhập?`,()=>{_(``),D(null)})}function j(){navigator.clipboard.writeText(f).then(()=>e(`Đã copy prompt — dán vào ChatGPT/Gemini`)).catch(()=>e(`Không copy được, trình duyệt chặn clipboard`,`error`))}return b?(0,d.jsx)(`div`,{style:{padding:40,color:`var(--text2)`},children:`Đang tải...`}):(0,d.jsxs)(d.Fragment,{children:[(0,d.jsxs)(`div`,{className:`section-header`,children:[(0,d.jsx)(`h2`,{className:`section-title`,children:h?`Sửa nội dung: ${v}`:`Import Lesson`}),(0,d.jsx)(`button`,{className:`btn btn-ghost`,onClick:()=>n(`/vocabulary-lessons`),children:`← Quay lại danh sách`})]}),(0,d.jsx)(`div`,{style:{display:`flex`,gap:8,marginBottom:10},children:(0,d.jsx)(`button`,{className:`btn btn-ghost btn-sm`,onClick:j,children:`🤖 Copy AI Prompt`})}),(0,d.jsxs)(`div`,{className:`form-group`,children:[(0,d.jsx)(`label`,{className:`form-label`,children:`Paste Lesson (định dạng EnglishWithDan Lesson Format)`}),(0,d.jsx)(`textarea`,{className:`form-input`,rows:18,value:g,onChange:e=>{_(e.target.value),D(null)},placeholder:`@lesson
